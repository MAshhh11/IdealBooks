    ...
    <article id="cartouche">
        <div id="text-welcome">
            ...
            <p>Here is your profile, you can decide whether to update it or to add new wine in our database:</p>
                <a href="add_book.php" class="button3">ADD BOOK</a>
                <a href="booklist.php" class="button3">LIBRARY</a>
            </div>
            <div id="card3">
                <?php
                ...
                <?php
                    ...
                    <p class="mb-5">For any request contact an admin at admin@idealbooks.com</p>
        <?php  }
                ?>
            </div>
        </div>
